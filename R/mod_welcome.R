              ...
              bslib::layout_columns(
                ...
                shiny::column(
                  ...
                  bslib::card(
                    ...
                    bslib::card_body(
                      "Detect outliers and inspect data",
                ...
                shiny::column(
                  ...
                  bslib::card(
                    ...
                    bslib::card_body("Remove noise from sensor (such as body weight) and
                                     download the data as a CalR file",
                                     shinyWidgets::actionBttn(
                                       inputId = ns("trim_sensor"),
                                       style = "jelly",
                                       label = "launch sensor trimmer",
                                       size = "s",
                                       block = F
                                     ))
                  )
